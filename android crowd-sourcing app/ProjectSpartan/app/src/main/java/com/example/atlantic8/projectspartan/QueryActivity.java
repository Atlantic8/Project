...
public class QueryActivity extends AppCompatActivity {
    ...
    private String username, SessionId, TAG="QueryActivity";
    public String destinationAddress;
    Button btnPoseQuestion;
    ...
    private void init() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(QueryActivity.this, SubmitQueryActivity.class);
        ...
        btnPoseQuestion = (Button)findViewById(R.id.btn_pose_question);
        btnPoseQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QueryActivity.this, PoseQuestion.class);
                startActivity(intent);
            }
        });
